...
"""This package contains round behaviours of PrimeNumberAbciApp."""
...
from packages.arshy.skills.prime_number_app.behaviours import (
    PrimeNumberBaseBehaviour,
    PrimeNumberRoundBehaviour,
...
class BasePrimeNumberTest(FSMBehaviourBaseCase):
    """Base test case."""

    path_to_skill = Path(__file__).parent.parent

    behaviour: PrimeNumberRoundBehaviour
    behaviour_class: Type[PrimeNumberBaseBehaviour]
    next_behaviour_class: Type[PrimeNumberBaseBehaviour]
...
class TestCollectRandomnessBehaviour(BasePrimeNumberTest):
...
class TestLLMCallandPrintMessageBehaviour(BasePrimeNumberTest):
    """Tests LLMCallandPrintMessageBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = LLMCallandPrintMessageBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...
...
class TestRegistrationBehaviour(BasePrimeNumberTest):
...
class TestResetAndPauseBehaviour(BasePrimeNumberTest):
...
class TestSelectKeeperBehaviour(BasePrimeNumberTest):
